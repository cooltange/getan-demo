...
<div id="bigbox">
    <div class="title clearfix"><div style="float: left">Apache Shiro Sample App - Home</div><div class="info" >Logged in as ${currentUser.username} (<a href="<c:url value="/s/logout.action"/>">Logout</a>)</div></div>
    ...
    <div class="content">
        ...
        <shiro:hasPermission name="user:manage">
            Since you are logged in as the admin user, you can <a href="<c:url value="/s/manageUsers.action"/>">manage site users</a>.
        </shiro:hasPermission>
